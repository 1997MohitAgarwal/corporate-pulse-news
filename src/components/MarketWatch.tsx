            ...
            <div className="p-4 sm:p-6 h-full flex flex-col">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 flex-1">
                {marketData.map((item, index) => {
                  ...
                  return (
                    <div key={index} className={`group p-3 sm:p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 backdrop-blur-sm relative overflow-hidden min-h-[120px] sm:min-h-[130px] flex flex-col justify-between ${
                      item.trend === 'up' 
                      ...
                      <div className="relative z-10 flex flex-col h-full justify-between">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-slate-900 text-xs sm:text-xs tracking-wide">{item.symbol}</span>
                          </div>
                        </div>
                        
                        <div className="text-base sm:text-lg font-bold text-slate-900 mb-2">{item.value}</div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="w-6 sm:w-8 bg-gray-200 rounded-full h-1 sm:h-1.5 overflow-hidden">
