  ...
  const sideStories = [
    {
      ...
      excerpt: "Updated SEC guidelines create new pathways for emerging technology companies...",
    ...
    },
    {
      ...
      excerpt: "Global commerce patterns shift as major economies reassess trade relationships...",
    ...
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white border-none px-6 py-2">
            Breaking News
          </Badge>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="group overflow-hidden bg-white shadow-2xl hover:shadow-3xl transition-all duration-500 border-0 rounded-3xl">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-6 left-6">
                  <Badge className="bg-amber-500 text-slate-900 font-semibold px-4 py-2">
          ...
          <div className="space-y-6">
            {sideStories.map((story, index) => (
              <Card key={index} className="group overflow-hidden bg-white shadow-xl hover:shadow-2xl transition-all duration-300 border-0 rounded-2xl">
                <div className="relative overflow-hidden">
                  <img
                    src={story.image}
                    alt={story.title}
                  ...
                  <div className="absolute top-4 left-4">
                    <Badge className="bg-white/90 text-slate-900 font-semibold text-xs px-3 py-1">
                      {story.category}
                    </Badge>
                  </div>
                </div>
