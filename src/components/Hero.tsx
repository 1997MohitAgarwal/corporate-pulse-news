...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden min-h-[90vh] flex items-center">
      ...
      {/* Optimized background image with loading priority */}
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=800&q=75')] bg-cover bg-center opacity-10"></div>
      <div className="absolute inset-0 bg-gradient-to-r from-slate-900/90 via-slate-800/80 to-slate-900/90"></div>
      
      {/* Reduced and optimized animated background elements */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-amber-500/5 rounded-full blur-2xl animate-pulse"></div>
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-blue-500/5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: "1s" }}></div>
      ...
      <div className="relative container mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="flex justify-start animate-fade-in" style={{ animationDelay: "600ms" }}>
              <Button 
                ...
                className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-900 font-bold px-8 py-4 text-lg group shadow-2xl hover:shadow-amber-500/25 transition-all duration-300"
              >
                Get Started
          ...
          <div className="relative animate-scale-in" style={{ animationDelay: "400ms" }}>
            <div className="absolute inset-0 bg-gradient-to-r from-amber-500/20 to-blue-500/20 rounded-3xl blur-2xl animate-pulse"></div>
            <div className="relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-lg rounded-3xl p-8 border border-slate-700/50 shadow-2xl">
              <img
                src="https://images.unsplash.com/photo-1496307653780-42ee777d4833?w=600&q=80"
